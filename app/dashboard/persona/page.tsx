...
export default function PersonaPage() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader
        title="AI Persona"
        description="Train the AI twin that represents you on yogi.ai."
        actions={
          <>
        ...
        <div className="space-y-6 lg:col-span-7">
          ...
          <div className="rounded-2xl border bg-card p-6">
            ...
            <div className="mt-4 divide-y">
              {[
                {
                  name: "AI SaaS playbook.md",
                  type: "Markdown",
                  size: "182 KB"
                },
                {
                  name: "Pricing & objections.notion",
                  type: "Notion",
                  size: "Synced"
                },
                {
                  name: "github.com/yogi/lean-saas",
                  type: "Repo",
                  size: "32 files"
                },
                {
                  name: "Customer interviews — Q3.csv",
                  type: "Dataset",
                  size: "1,204 rows"
                }
              ].map((k) => (
